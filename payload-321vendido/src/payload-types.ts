...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "rematadores".
 */
export interface Rematadore {
  id: number;
  name: string;
  address?: string | null;
  phone?: string | null;
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "rematadores_select".
 */
export interface RematadoresSelect<T extends boolean = true> {
  name?: T;
  address?: T;
  phone?: T;
  website?: T;
